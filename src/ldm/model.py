...
from diffusers.models.unets.unet_2d import (
    ModelMixin, ConfigMixin, register_to_config,
    GaussianFourierProjection, Timesteps,
    TimestepEmbedding, get_down_block,
...
class UNet2DModel(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        return_midblock_feature: bool = False,  # https://arxiv.org/pdf/2401.00110v5
        ...
        **kwargs,
        ...
        Args:
            ...
            output_type (`str`, *optional*, defaults to `"pil"`):
                The output format of the generated image. Choose between `PIL.Image` or `np.ndarray`.
            return_dict (`bool`, *optional*, defaults to `True`):
